...
namespace ConsoleExtensions {
    ...
    internal class ConsoleCodeEditor {
        ...
        /// </summary>
        public const int LineNumberWidth = 7;
        ...
        private int cursorX {
            ...
            set {
                ...
                if (length >= Console.BufferWidth) {
                    ...
                    int maxLength = lines.Max(x => x.Length) + editBoxX;
        ...
        /// </summary>
        private readonly IConsoleSyntaxHighlighter highlighter;

        private readonly Stopwatch highlightingWatch = new Stopwatch();
        private          bool      lastTimeRendered;
        ...
        private       string lastMessage    = defaultMessage;
        ...
        public ConsoleCodeEditor(
            ...
            IConsoleSyntaxHighlighter highlighter   = null
        ) {
            ...
            if (singleLineMode && prompt.Length > 0) {
                ...
                // + 1 for a gap between line number bound size and the code.
            }
        ...
        /// </summary>
        private string[] ReadLines() { // BUG: lines were split incorrectly
            // writing loop
        ...
        public static void PrintLineNumber(int lineNumber) {
            ...
            // file too large to display. (from 301 lines)
            else {
        ...
        private void PrintError(Exception error) {
            ...
            ConsoleUI.WithPosition(
                messageBoxX, messageBoxY, () => {
                    ConsoleUI.Write((lastMessage, ConsoleColor.DarkRed));
                }
            );
        }
        ...
        private void PrintWarning(Exception warning) {
            ...
            ConsoleUI.WithPosition(
                messageBoxX, messageBoxY, () => {
                    ConsoleUI.Write((lastMessage, ConsoleColor.DarkYellow));
                }
            );
        }
